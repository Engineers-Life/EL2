...
// BLAST FURNACE
<item:immersiveengineering:slab_coke>.burnTime = <item:immersiveengineering:coke>.burnTime/2;
<recipetype:immersiveengineering:blast_furnace_fuel>.addFuel("slab_coke_as_blast_furnace_fuel",<item:immersiveengineering:slab_coke>,<item:immersiveengineering:slab_coke>.burnTime*6/16);
