...
mods.jei.JEI.addInfo(<item:minecraft:soul_campfire>, ["To create a Soul Campfire you need fire starter. Throw (Q) the following items on the ground, in the space where you want to create the campfire:", "- One wooden fuel item (any log or plank)", "- Three pieces of kindling (sticks, saplings, leaves, or string)", "- Throw a single piece of either soul sand, or soul soil.", "Then, right click and hold the fire starter pointing at the pile of items. Smoke particles will appear, and after a short while, a campfire will appear and the items will be consumed."]);
...
mods.jei.JEI.addInfo(<item:minecraft:iron_shovel>, ["Vanilla tools are disabled! Please use tools from @Tetra mod. You can find all info in Quest book or in online guides."]);
mods.jei.JEI.addInfo(<item:minecraft:iron_pickaxe>, ["Vanilla tools are disabled! Please use tools from @Tetra mod. You can find all info in Quest book or in online guides."]);
mods.jei.JEI.addInfo(<item:minecraft:iron_axe>, ["Vanilla tools are disabled! Please use tools from @Tetra mod. You can find all info in Quest book or in online guides."]);
mods.jei.JEI.addInfo(<item:minecraft:diamond_shovel>, ["Vanilla tools are disabled! Please use tools from @Tetra mod. You can find all info in Quest book or in online guides."]);
mods.jei.JEI.addInfo(<item:minecraft:diamond_pickaxe>, ["Vanilla tools are disabled! Please use tools from @Tetra mod. You can find all info in Quest book or in online guides."]);
mods.jei.JEI.addInfo(<item:minecraft:diamond_axe>, ["Vanilla tools are disabled! Please use tools from @Tetra mod. You can find all info in Quest book or in online guides."]);
mods.jei.JEI.addInfo(<item:minecraft:stone_shovel>, ["Vanilla tools are disabled! Please use tools from @Tetra mod. You can find all info in Quest book or in online guides."]);
mods.jei.JEI.addInfo(<item:minecraft:stone_pickaxe>, ["Vanilla tools are disabled! Please use tools from @Tetra mod. You can find all info in Quest book or in online guides."]);
mods.jei.JEI.addInfo(<item:minecraft:stone_axe>, ["Vanilla tools are disabled! Please use tools from @Tetra mod. You can find all info in Quest book or in online guides."]);
mods.jei.JEI.addInfo(<item:minecraft:wooden_shovel>, ["Vanilla tools are disabled! Please use tools from @Tetra mod. You can find all info in Quest book or in online guides."]);
mods.jei.JEI.addInfo(<item:minecraft:wooden_pickaxe>, ["Vanilla tools are disabled! Please use tools from @Tetra mod. You can find all info in Quest book or in online guides."]);
mods.jei.JEI.addInfo(<item:minecraft:wooden_axe>, ["Vanilla tools are disabled! Please use tools from @Tetra mod. You can find all info in Quest book or in online guides."]);

<item:minecraft:iron_shovel>.addTooltip("Disabled. Use @Tetra tools.");
<item:minecraft:iron_pickaxe>.addTooltip("Disabled. Use @Tetra tools.");
<item:minecraft:iron_axe>.addTooltip("Disabled. Use @Tetra tools.");
<item:minecraft:diamond_shovel>.addTooltip("Disabled. Use @Tetra tools.");
<item:minecraft:diamond_pickaxe>.addTooltip("Disabled. Use @Tetra tools.");
<item:minecraft:diamond_axe>.addTooltip("Disabled. Use @Tetra tools.");
<item:minecraft:stone_shovel>.addTooltip("Disabled. Use @Tetra tools.");
<item:minecraft:stone_pickaxe>.addTooltip("Disabled. Use @Tetra tools.");
<item:minecraft:stone_axe>.addTooltip("Disabled. Use @Tetra tools.");
<item:minecraft:wooden_shovel>.addTooltip("Disabled. Use @Tetra tools.");
<item:minecraft:wooden_pickaxe>.addTooltip("Disabled. Use @Tetra tools.");
<item:minecraft:wooden_axe>.addTooltip("Disabled. Use @Tetra tools.");
