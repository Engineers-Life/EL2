...
val pc_upgrade = <tag:items:pneumaticcraft:upgrade_components>;
...
craftingTable.addShaped("soulcampfire",<item:minecraft:soul_campfire>, [
    [<item:minecraft:stick>, <item:minecraft:soul_sand>, <item:minecraft:stick>],
    [<item:minecraft:soul_sand>, <item:notreepunching:fire_starter>, <item:minecraft:soul_sand>],
...
craftingTable.removeByName("crafttweaker:flour_from_corn_new_output");
craftingTable.removeByName("crafttweaker:flour_from_forge_new_output");
craftingTable.removeByName("crafttweaker:flour_from_wheat_new_output");
craftingTable.removeByName("crafttweaker:flour_x1_flour_plants_new_output");
craftingTable.removeByName("vanillafoodpantry:bakery/portion_flour_from_wheat");
  craftingTable.addShapeless("flour_from_corn_new_output", <item:vanillafoodpantry:portion_flour>, [<item:veggie_way:mill>.anyDamage().transformDamage(), <tag:items:forge:corn>]);
  craftingTable.addShapeless("flour_from_forge_new_output", <item:vanillafoodpantry:portion_flour>, [<item:veggie_way:mill>.anyDamage().transformDamage(), <tag:items:forge:grain>]);
...
craftingTable.addShaped("pneumaticcraft_pressure_chamber_wall",<item:pneumaticcraft:pressure_chamber_wall>*8,
[ [<item:pneumaticcraft:reinforced_bricks>,<item:pneumaticcraft:reinforced_bricks>,<item:pneumaticcraft:reinforced_bricks>],
  [<item:pneumaticcraft:reinforced_bricks>,<item:industrialforegoing:machine_frame_simple>,<item:pneumaticcraft:reinforced_bricks>],
  [<item:pneumaticcraft:reinforced_bricks>,<item:pneumaticcraft:reinforced_bricks>,<item:pneumaticcraft:reinforced_bricks>]]);

craftingTable.removeRecipe(<item:pneumaticcraft:pressure_tube>);
craftingTable.addShaped("pneumaticcraft_pressure_tube",<item:pneumaticcraft:pressure_tube>*2,
[ [<item:minecraft:air>, <item:immersiveengineering:plate_steel>, <item:minecraft:air>],
  [<item:pneumaticcraft:ingot_iron_compressed>, <tag:items:forge:glass>, <item:pneumaticcraft:ingot_iron_compressed>],
  [<item:minecraft:air>, <item:immersiveengineering:plate_steel>, <item:minecraft:air>]]);

craftingTable.removeByName("pneumaticcraft:reinforced_stone");
craftingTable.addShaped("pneumaticcraft_reinforced_stone",<item:pneumaticcraft:reinforced_stone>*8,
[ [<item:minecraft:stone>,<item:immersiveengineering:plate_steel>,<item:minecraft:stone>],
  [<item:immersiveengineering:plate_steel>,<item:pneumaticcraft:ingot_iron_compressed>,<item:immersiveengineering:plate_steel>],
  [<item:minecraft:stone>,<item:immersiveengineering:plate_steel>,<item:minecraft:stone>]]);
  
<recipetype:pneumaticcraft:explosion_crafting>.removeRecipe(<item:pneumaticcraft:ingot_iron_compressed>);
<recipetype:immersiveengineering:arc_furnace>.addRecipe("ingot_iron_compressed", <item:minecraft:iron_ingot>*5, [<item:minecraft:gunpowder>], 400, 400*512, [<item:pneumaticcraft:ingot_iron_compressed>*4],<item:immersiveengineering:slag>);
