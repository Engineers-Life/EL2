...
<recipetype:immersiveengineering:arc_furnace>.addRecipe("graphite_dust", <tag:items:forge:charcoal>,[<tag:items:forge:bitumen>*2],100,51200,[<item:immersiveengineering:dust_hop_graphite>*3]);
<recipetype:immersiveengineering:arc_furnace>.addRecipe("blocks_to_graphite_dust",<tag:items:forge:storage_blocks/charcoal>,[<tag:items:forge:storage_blocks/bitumen>*2],800,409600,[<item:immersiveengineering:dust_hop_graphite>*27]);

// graphite dust and gas in mixer to make bio fuel
<recipetype:immersiveengineering:mixer>.addRecipe("bio_fuel_from_gas",<tag:fluids:forge:gasoline>,[<item:immersiveengineering:dust_hop_graphite>],3200,<fluid:industrialforegoing:biofuel>,500);
