...
<recipetype:immersiveengineering:mixer>.addRecipe("bio_fuel",<tag:fluids:forge:gasoline>, [<tag:items:forge:dusts/graphite>], 3200, <fluid:industrialforegoing:biofuel>, 500);
